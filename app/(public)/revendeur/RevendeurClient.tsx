...
import { geocodePostalCode, distanceKm, type RevendeurResult } from '@/lib/firestore/revendeurs';

export default function RevendeurClient({ revendeurs }: { revendeurs: RevendeurResult[] }) {
