    ...
    <div>
      <div className="text-center mb-8">
        <h1 className="text-2xl font-extrabold text-sv-primary mb-2 font-[family-name:var(--font-heading)]">
          <EditableText page="univers" id="h1">Nos Univers</EditableText>
        </h1>
        <p className="text-sm text-ink-secondary max-w-xl mx-auto">
          <EditableText page="univers" id="intro">Explorez nos thématiques et trouvez l&apos;inspiration pour vos événements.</EditableText>
        </p>

        {/* Réseaux sociaux */}
        <div className="flex items-center justify-center gap-4 mt-4">
          <a href="https://www.instagram.com/surprisez_vous/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-ink-secondary hover:text-sv-orange transition-colors">
          ...
          <a href="https://www.facebook.com/SurprisezVous/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-ink-secondary hover:text-sv-orange transition-colors">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          </a>
          <a href="https://www.linkedin.com/company/surprisez-vous/posts/?feedView=all" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-ink-secondary hover:text-sv-orange transition-colors">
