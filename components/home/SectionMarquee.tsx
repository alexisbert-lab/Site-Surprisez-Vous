...
export function SectionMarquee() {
  return (
    <section style={{ background: 'var(--color-bg)', borderTop: '1px solid #e2e8f0', borderBottom: '1px solid #e2e8f0', padding: '24px 0' }}>
      ...
      <div style={{ overflow: 'hidden', position: 'relative' }}>
        <div style={{ position: 'absolute', inset: 0, zIndex: 1, pointerEvents: 'none', background: 'linear-gradient(to right, var(--color-bg) 100px, transparent 100px, transparent calc(100% - 100px), var(--color-bg) calc(100% - 100px))' }} />
